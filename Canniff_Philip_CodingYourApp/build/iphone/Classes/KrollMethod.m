...
-(id)call:(NSArray*)args
{
	...
	{
		@throw [NSException exceptionWithName:@"org.canniff_philip_codingyourapp.kroll" reason:[NSString stringWithFormat:@"invalid method '%@'",NSStringFromSelector(selector)] userInfo:nil];
	}
	IMP methodFunction = [target methodForSelector:selector];
	id arg1=nil;
	id arg2=nil;
