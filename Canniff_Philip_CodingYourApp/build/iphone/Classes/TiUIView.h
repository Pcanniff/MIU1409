...
/**
 Base class for all Canniff_Philip_CodingYourApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Canniff_Philip_CodingYourApp view hierarchy (such as wrapped iOS UIViews) was touched.
