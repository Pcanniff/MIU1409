...
/**
 The base class for all Canniff_Philip_CodingYourApp modules
 */
...
/**
 Canniff_Philip_CodingYourApp Platform calls this method on startup.
 */
-(void)startup;

/**
 Canniff_Philip_CodingYourApp Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Canniff_Philip_CodingYourApp Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Canniff_Philip_CodingYourApp Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Canniff_Philip_CodingYourApp Platform calls this method on resume.
 @param sender The sender of the event.
 */
