...
// in simulator we redefine to format for Canniff_Philip_CodingYourApp Developer console
...
{\
	NSString * exceptionName = [@"org.canniff_philip_codingyourapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.canniff_philip_codingyourapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICanniff_Philip_CodingYourAppNativeItemNone = -1, 
	UICanniff_Philip_CodingYourAppNativeItemSpinner = -2,
	UICanniff_Philip_CodingYourAppNativeItemProgressBar = -3,
	
	UICanniff_Philip_CodingYourAppNativeItemSlider = -4,
	UICanniff_Philip_CodingYourAppNativeItemSwitch = -5,
	UICanniff_Philip_CodingYourAppNativeItemMultiButton = -6,
	UICanniff_Philip_CodingYourAppNativeItemSegmented = -7,
	
	UICanniff_Philip_CodingYourAppNativeItemTextView = -8,
	UICanniff_Philip_CodingYourAppNativeItemTextField = -9,
	UICanniff_Philip_CodingYourAppNativeItemSearchBar = -10,
	
	UICanniff_Philip_CodingYourAppNativeItemPicker = -11,
	UICanniff_Philip_CodingYourAppNativeItemDatePicker = -12,
	
	UICanniff_Philip_CodingYourAppNativeItemInfoLight = -13,
	UICanniff_Philip_CodingYourAppNativeItemInfoDark = -14,
	
	UICanniff_Philip_CodingYourAppNativeItemDisclosure = -15,
	
	UICanniff_Philip_CodingYourAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Canniff_Philip_CodingYourApp instances of
