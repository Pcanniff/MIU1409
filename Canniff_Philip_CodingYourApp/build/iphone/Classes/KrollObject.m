...
//@interface Canniff_Philip_CodingYourAppObject : NSObject
//@end

@interface Canniff_Philip_CodingYourAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Canniff_Philip_CodingYourAppObject class]])
		{
			for (NSString *key in [[(Canniff_Philip_CodingYourAppObject*)o modules] allKeys])
			{
