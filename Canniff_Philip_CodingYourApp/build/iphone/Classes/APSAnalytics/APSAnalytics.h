 ...
 * to send analytic data that can be viewed on the Canniff_Philip_CodingYourApp Dashboard.
 *
 * For information on getting started with Canniff_Philip_CodingYourApp Platform Services,
