...
//Rare exceptions to indicate a bug in the _canniff_philip_codingyourapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Canniff_Philip_CodingYourApp proxies.
 */
