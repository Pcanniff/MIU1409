...
@interface Canniff_Philip_CodingYourAppObject : KrollCoverageObject {
#else
@interface Canniff_Philip_CodingYourAppObject : KrollObject {
#endif
@private
...
extern NSString * Canniff_Philip_CodingYourApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Canniff_Philip_CodingYourAppObject *_canniff_philip_codingyourapp;
    KrollObject* console;
	BOOL shutdown;
